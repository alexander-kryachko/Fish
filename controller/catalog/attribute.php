	...
	private $error = array();
  	...
  	protected function getForm() {
		...
		if (isset($this->request->post['enabled'])) {
			...
			$this->data['enabled'] = $attribute_info['enabled'];
		} else {
			$this->data['enabled'] = 1;
		}
		
		if (isset($this->request->post['breadcrumbs'])) {
			$this->data['breadcrumbs'] = $this->request->post['breadcrumbs'];
		} elseif (!empty($attribute_info)) {
			$this->data['breadcrumbs'] = $attribute_info['breadcrumbs'];
		} else {
			$this->data['breadcrumbs'] = 1;
		}
