...
class ControllerCatalogReview extends Controller {
	...
	protected function getList() {
    	...
    	foreach ($results as $result) {
			...
			$this->data['reviews'][] = array(
                ...
                'rating_service' => $result['rating_service'],
        ...
        $this->data['column_rating_service'] = $this->language->get('column_rating_service');
        ...
        $this->data['sort_rating_service'] = $this->url->link('catalog/review', 'token=' . $this->session->data['token'] . '&sort=r.rating_service' . $url, 'SSL');
	...
	protected function getForm() {
        ...
        $this->data['entry_rating_service'] = $this->language->get('entry_rating_service');
        ...
        if (isset($this->error['rating_service'])) {
            $this->data['error_rating_service'] = $this->error['rating_service'];
        } else {
            $this->data['error_rating_service'] = '';
        }
        ...
        if (isset($this->request->post['rating_service'])) {
            $this->data['rating_service'] = $this->request->post['rating_service'];
        } elseif (!empty($review_info)) {
            $this->data['rating_service'] = $review_info['rating_service'];
        } else {
            $this->data['rating_service'] = '';
        }
	...
	protected function validateForm() {
        ...
        if (!isset($this->request->post['rating_service'])) {
            $this->error['rating_service'] = $this->language->get('error_rating_service');
        }
