...
class ControllerSaleAdvancedCoupon extends Controller {
	private $error = array();
  	...
  	private function getForm() {
		...
		$this->data['entry_quantity_types'] = $this->language->get('entry_quantity_types');
		...
		$this->data['entry_quantity_buy_type'] = $this->language->get('entry_quantity_buy_type');
		$this->data['entry_everyone'] = $this->language->get('entry_everyone');
		$this->data['entry_anyone'] = $this->language->get('entry_anyone');
		...
		$this->data['tab_errors'] = $this->language->get('tab_errors');
		$this->data['tab_data'] = $this->language->get('tab_data');
		$this->data['tab_advanced_coupon_history'] = $this->language->get('tab_advanced_coupon_history');

		$this->data['token'] = $this->session->data['token'];
		
		/*hardik upgredation code start*/
		// edited on 09/06/2013
		$this->data['entry_rules_type'] = $this->language->get('entry_rules_type');
		$this->data['entry_rules_value'] = $this->language->get('entry_rules_value');
		$this->data['entry_rules'] = $this->language->get('entry_rules');
		$this->data['entry_rules_message'] = $this->language->get('entry_rules_message');
		
		// edited on 10/06/2013
		$this->data['entry_allow_discount'] = $this->language->get('entry_allow_discount');
		
		// edited on 12/06/2013
		$this->load->model('localisation/language');
		
		$this->data['languages'] = $this->model_localisation_language->getLanguages();
		
		// edited on 15/06/2013
		$this->data['entry_error_blank'] = $this->language->get('entry_error_blank');
		$this->data['entry_error_not_found'] = $this->language->get('entry_error_not_found');
		$this->data['entry_error_total_quantity_range'] = $this->language->get('entry_error_total_quantity_range');
		$this->data['entry_error_total_quantity'] = $this->language->get('entry_error_total_quantity');
		$this->data['entry_error_total_amount_range'] = $this->language->get('entry_error_total_amount_range');
		$this->data['entry_error_total_amount'] = $this->language->get('entry_error_total_amount');
		$this->data['entry_error_login'] = $this->language->get('entry_error_login');
		$this->data['entry_error_other_coupon'] = $this->language->get('entry_error_other_coupon');
		$this->data['entry_error_special_product'] = $this->language->get('entry_error_special_product');
		$this->data['entry_error_discount_product'] = $this->language->get('entry_error_discount_product');
		$this->data['entry_error_total_uses_sale'] = $this->language->get('entry_error_total_uses_sale');
		$this->data['entry_error_total_uses_customer'] = $this->language->get('entry_error_total_uses_customer');
		$this->data['entry_error_set_disable'] = $this->language->get('entry_error_set_disable');
		
		/*hardik upgredation code end*/
		...
		//print "<pre>"; print_r($advanced_coupon_info); //exit;
		
		if (isset($this->request->post['advanced_coupon'])) {
      		$this->data['advanced_coupon'] = $this->request->post['advanced_coupon'];
    	} elseif (isset($this->request->get['advanced_coupon_id'])) {
    		//echo $this->request->get['advanced_coupon_id'];
			$this->data['advanced_coupon'] = $this->model_sale_advanced_coupon->getAdvanceCouponData($this->request->get['advanced_coupon_id']);
		} else {
      		$this->data['advanced_coupon'] = array();
    	}
		
		/*hardik upgredation code start*/
		if (isset($this->request->post['allow_discount'])) {
      		$this->data['allow_discount'] = $this->request->post['allow_discount'];
    	} elseif (!empty($sales_promotion_info)) {
			$this->data['allow_discount'] = $advanced_coupon_info['allow_discount'];
		} else {
      		$this->data['allow_discount'] = '';
		}	
		/*hardik upgredation code end*/
		...
		/*hardik upgredation code start*/
		/*
		if (isset($this->request->post['discount_rules_type'])) {
      		$this->data['discount_rules_type'] = $this->request->post['discount_rules_type'];
    	} elseif (!empty($advanced_coupon_info)) {
			$this->data['discount_rules_type'] = $advanced_coupon_info['discount_rules_type'];
		} else {
      		$this->data['type'] = '';
    	}
		
		if (isset($this->request->post['discount_rules_value'])) {
      		$this->data['discount_rules_value'] = $this->request->post['discount_rules_value'];
    	} elseif (!empty($advanced_coupon_info)) {
			$this->data['discount_rules_value'] = $advanced_coupon_info['discount_rules_value'];
		} else {
      		$this->data['discount_rules_value'] = '';
    	}
		
		if (isset($this->request->post['discount_rules'])) {
      		$this->data['discount_rules'] = $this->request->post['discount_rules'];
    	} elseif (!empty($advanced_coupon_info)) {
			$this->data['discount_rules'] = $advanced_coupon_info['discount_rules'];
		} else {
      		$this->data['discount_rules'] = '';
    	}
		*/
		/*hardik upgredation code end*/
		...
		if (isset($this->request->post['category_buy'])) {
      		$this->data['category_buy_ids'] = $this->request->post['category_buy'];
    	} elseif (!empty($advanced_coupon_info)) {
			$this->data['category_buy_ids'] = $advanced_coupon_info['category_buy'];
		} else {
      		$this->data['category_buy_ids'] = array();
    	}
		
		if (isset($this->request->post['manufacturer_buy'])) {
      		$this->data['manufacturer_buy_ids'] = $this->request->post['manufacturer_buy'];
    	} elseif (!empty($advanced_coupon_info)) {
			$this->data['manufacturer_buy_ids'] = $advanced_coupon_info['manufacturer_buy'];
		} else {
      		$this->data['manufacturer_buy_ids'] = array();
    	}
		
		if (isset($this->request->post['category'])) {
      		$this->data['category_ids'] = $this->request->post['category'];
    	} elseif (!empty($advanced_coupon_info)) {
			$this->data['category_ids'] = $advanced_coupon_info['category'];
		} else {
      		$this->data['category_ids'] = array();
    	}
		
		if (isset($this->request->post['manufacturer'])) {
      		$this->data['manufacturer_ids'] = $this->request->post['manufacturer'];
    	} elseif (!empty($advanced_coupon_info)) {
			$this->data['manufacturer_ids'] = $advanced_coupon_info['manufacturer'];
		} else {
      		$this->data['manufacturer_ids'] = array();
    	}
		
		if (isset($this->request->post['product_buy_type'])) {
      		$this->data['product_buy_type'] = $this->request->post['product_buy_type'];
    	} elseif (!empty($advanced_coupon_info)) {
			$this->data['product_buy_type'] = $advanced_coupon_info['product_buy_type'];
		} else {
      		$this->data['product_buy_type'] = '1';
    	}
		
		if (isset($this->request->post['product_type'])) {
      		$this->data['product_type'] = $this->request->post['product_type'];
    	} elseif (!empty($advanced_coupon_info)) {
			$this->data['product_type'] = $advanced_coupon_info['product_type'];
		} else {
  	...
  	private function validateForm() {
    	if (!$this->user->hasPermission('modify', 'sale/advanced_coupon')) {
      	...
      	foreach ($this->request->post['advanced_coupon'] as $language_id => $value) {
