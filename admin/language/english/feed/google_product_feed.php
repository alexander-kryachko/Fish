...
$_['alert_disable']        			= 'You are about to disable all products for Google Shopping';
$_['alert_copy_data']       		= 'You are about to copy default Google Product Feed values to your products';
...
$_['text_custom_labels_group']    	= 'Custom Labels Definition ';
$_['text_custom_labels_help']    	= '<br /><span class="help">Enter your Custom Labels here as a comma separated list<br /><br />The Custom Labels Definition is not used by Google, but is provided to help you categorise / identify the different groups of labels.';
...
$_['text_general']        			= '<h1 style="color: #ff8000">General:</h1><span class="help">Set the default values for your feed.<br />Please note, these will not be automatically copied to existing products. Use the "<strong>Copy</strong>" function at the bottom of this page';
$_['text_custom_labels']     		= '<h1 style="color: #ff8000">Custom Labels:</h1><br /><span class="help">Find out more about Custom Labels <a href="https://support.google.com/merchants/answer/188494#customlabel" target="_blank">here</a>';
$_['text_copy']        				= '<h1 style="color: #ff8000">Copy:</h1>';
...
$_['entry_custom_label']     		= 'Custom Label ';
$_['entry_custom_labels']     		= 'Custom Labels';
...
$_['entry_copy_gtin']   			= 'Global Trade Item Number:<br/><span class="help">This is the UPC, EAN, JAN or ISBN number of the item. If you already have the GTIN data in another field, you can copy it across rather than have to re-input the information. Simply select the field to copy from and click the COPY button.</span>';
$_['entry_copy_mpn']   				= 'Manufacturer Part Number:<br/><span class="help">If you already have the MPN data in another field, you can copy it across rather than have to re-input the information. Simply select the field to copy from and click the COPY button.</span>';
$_['entry_default_google_product_category'] = 'Default Google Product Category:<br/><span class="help">Click on the "+" icon to open a new window showing the Google categories. Copy and Paste the category which best describes the majority of your products. <br /><br />Click the Copy button to copy this value to every product in your catalog. <br /><br />This default value can be overridden in the <strong>Product Feed</strong> tab when editing individual products. <br /><br /><span style="color:rgb(255, 0, 0)"><strong>IMPORTANT: </STRONG>Make sure the default currency is correctly set before selecting the product category or your entire product feed could be rejected by Google!</span></span>';
...
$_['entry_copy_manufacturer'] 		= 'Brand:<br/><span class="help">Would you like to automatically copy data from the Manufacturer field each time Manufacturer is updated?';
$_['entry_copy_fields'] 			= 'Copy Fields:<br/><span class="help">Select the default values you would like to copy to your existing products.</span>';
$_['entry_replace_av_for_order'] 	= 'Replace Available for Order:<br/><span class="help">The Out of Stock Status "<strong>Available for Order</strong>" is no longer used in Google Shopping. Check this box to replace all "Available for Order" entries with "Out of Stock".</span>';
$_['entry_copy_to'] 				= 'Copy To:<br/><span class="help">Which products would you like to copy this data to.</span>';
...
$_['entry_size_system'] 			= 'Size System:<br/><span class="help">For Apparel Items.</span>';
$_['entry_size_type']    			= 'Size Type:<br/><span class="help">For Apparel Items. Check the Google Product Specification for your country - some of the available values can not be used in some countries.</span>';
...
$_['entry_gpf_mobile_url']     		= 'Mobile Landing Page:<br/><span class="help">If you have a separate site that mobile devices are redirected to, enter the url here. Be sure to include a trailing slash ("/")<br /><br />For example:<br />http://www.yourdomain.mobi/<br />http://www.mobile.yourdomain.com/<br />http://www.yourdomain.com/mobile/  etc.<br /><br />Leave blank if you don\'t have a separate mobile site or if you are using a responsive theme.</span>';
$_['entry_information'] 			= '<h1 style="color: #ff8000">Other information:</h1><span class="help">Google are very specific about their requirements for product feeds and it is extremely important that you adhere to their specifications otherwise your whole feed may be rejected.<br /><br />It is strongly recommended that you familiarise yourself with Googles\' policies on Product Feeds before deciding which fields to complete.<br /><br />Check out the Google Products Specification <a href="http://support.google.com/merchants/bin/answer.py?hl=en&answer=188494#GB" target="_blank">here</a><br /><br />There is a useful Summary of Attribute Requirements <a href="http://support.google.com/merchants/bin/answer.py?hl=en&answer=1344057&topic=2473824&ctx=topic#GB" target="_blank">here</a><br /><br />This <a href="http://support.google.com/merchants/bin/answer.py?hl=en&answer=160161&topic=2473824&ctx=topic" target="_blank">link</a> explains the different Unique Product Identifiers available (Global Trade Item Numbers and Manufacturers Part Numbers)<br /><br />Clothing (Apparel) has a particular specification and this is summarised <a href="http://support.google.com/merchants/bin/answer.py?hl=en&answer=1347943&topic=2473824&ctx=topic" target="_blank">here</a>.</span>';
$_['entry_troubleshooting'] 		= '<h1 style="color: #ff8000">Troubleshooting:</h1><span class="help">Click on the links below for the solution to the most common problems encountered</span><ul><li><a href="http://www.showmeademo.co.uk/help/troubleshooting.htm" target="_blank">How do I upload my Feed to Google Merchant Center</a></li><li><a href="http://www.showmeademo.co.uk/help/troubleshooting.htm" target="_blank">I am getting an error message "Undefined Index: gpf_status"</a></li><li><a href="http://www.showmeademo.co.uk/help/troubleshooting.htm" target="_blank">I have 450 products, but only 27 have uploaded to Google Merchant Center</a></li><li><a href="http://www.showmeademo.co.uk/help/troubleshooting.htm" target="_blank">My feed has uploaded, but I\'m getting the error "0 of 22 items inserted"</a></li></ul>';
