...
$_['entry_sku']              = 'SKU или код поставщика:';
$_['entry_upc']              = 'UPC - Стикер в карточке:<br/><span class="help">top - топ продаж, new - новинка, special - акция, price - суперцена, gift - на подарок</span>';
$_['entry_ean']              = 'EAN - Стикер в категории:<br/><span class="help">freeship - беспл. доставка, freeshippac - беспл.доставка + упаковка, pack - беспл. упаковка</span>';
$_['entry_jan']              = 'JAN:<br/><span class="help">Японский артикул</span>';
$_['entry_isbn']             = 'ISBN:<br/><span class="help">Международный стандарт номера книги</span>';
$_['entry_mpn']              = 'MPN:<br/><span class="help">Номер производителя</span>';
...
$_['error_model']            = 'Код товара должен быть от 3 до 64 символов!';
?>
