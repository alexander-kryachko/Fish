...
$_['entry_data_feed']    = 'Адрес экспорта:<br/><span class="help">Если вы формируете файл экспорта скриптом по запросу Softcube.</span>';
...
$_['entry_shopname']     = 'Название магазина:<br/><span class="help">Короткое название магазина (название, которое выводится в списке найденных на Softcube товаров. Не должно содержать более 20 символов).</span>';
...
$_['entry_currency']     = 'Валюта предложений:<br/><span class="help">Softcube принимает предложения в валюте RUR, RUB, BYR, KZT или UAH. Выберите валюту в которой будут передаваться предложения.</span>';
...
$_['entry_numpictures']  = 'Кол-во картинок товара:<br/><span class="help">Сколько фотографий товара экспортировать. Softcube принимает не более десяти.</span>';

$_['tab_categories'] 	 = 'Что экспортировать';
$_['entry_category']     = 'Категории:<br/><span class="help">Отметьте категории из которых надо экспортировать предложения для Softcube.<br />Если ничего не отмечено, то будут выгружаться все категории.</span><br/>Категории Softcube<br/><span class="help">В правом поле ввода можно указать каким <a href="http://cards2.yandex.net/hlp-get/6213/xls/category_tree-.xls">категориям Softcube</a> соответствуют ваши категории, например: "Одежда&nbsp;и&nbsp;обувь/Обувь/Мужская/Кеды"Б.</span>';
...
$_['tab_attributes_description'] = 'Softcube рекомендует в экспорте разделять значение атрибута и единицу измерения.
...
$_['entry_attributes'] 	 = 'Экспортруемые атрибуты:<br/><span class="help">Выбранные атрибуты, если они присутствуют у товара, будут экспортироваться в Softcube (в виде тэгов &lt;param&gt;).</span>';
...
$_['tab_tailor_description'] = 'Для каждого товара у которого можно выбрать цвет и размер, в Softcube будет выгружаться несколько товарных предложений - для
