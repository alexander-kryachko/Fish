  ...
  <div class="content">
   ...
   <a href="#tab-filelist"><?php echo $tab_filelist; ?></a>
	...
	<tr>
	 ...
	 <td class="left"><select name="cache[featuredmodule][status]">
	                <?php if ($cache['featuredmodule']['status']) { ?>
                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                <option value="0"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_enabled; ?></option>
	...
	<td class="left"><input size="2" name="cache[featuredmodule][lifetime]" value="<?php echo $cache['featuredmodule']['lifetime']; ?>"></td>
	 <td class="left"><a href="<?php echo $clear_featuredmodule; ?>" class="button"><?php echo $button_clear; ?></a></td>
	 <td class="left"><?php echo $cache['featuredmodule']['size']; ?></td>
	</tr>
	
	<tr>
	 <td class="left"><?php echo $entry_bestseller; ?></td>
	 <td class="left"><select name="cache[bestsellermodule][status]">
	                <?php if ($cache['bestsellermodule']['status']) { ?>
                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                <option value="0"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_enabled; ?></option>
	...
	<td class="left"><input size="2" name="cache[bestsellermodule][lifetime]" value="<?php echo $cache['bestsellermodule']['lifetime']; ?>"></td>
	 <td class="left"><a href="<?php echo $clear_bestsellermodule; ?>" class="button"><?php echo $button_clear; ?></a></td>
	 <td class="left"><?php echo $cache['bestsellermodule']['size']; ?></td>
	</tr>
	
	<tr>
	 <td class="left"><?php echo $entry_latest; ?></td>
	 <td class="left"><select name="cache[latestmodule][status]">
	                <?php if ($cache['latestmodule']['status']) { ?>
                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                <option value="0"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_enabled; ?></option>
	...
	<td class="left"><input size="2" name="cache[latestmodule][lifetime]" value="<?php echo $cache['latestmodule']['lifetime']; ?>"></td>
	 <td class="left"><a href="<?php echo $clear_latestmodule; ?>" class="button"><?php echo $button_clear; ?></a></td>
	 <td class="left"><?php echo $cache['latestmodule']['size']; ?></td>
	</tr>	
	
	<tr>
	 <td class="left"><?php echo $entry_special; ?></td>
	 <td class="left"><select name="cache[specialmodule][status]">
	                <?php if ($cache['specialmodule']['status']) { ?>
                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                <option value="0"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_enabled; ?></option>
	...
	<td class="left"><input size="2" name="cache[specialmodule][lifetime]" value="<?php echo $cache['specialmodule']['lifetime']; ?>"></td>
	  <td class="left"><a href="<?php echo $clear_specialmodule; ?>" class="button"><?php echo $button_clear; ?></a></td>
	 <td class="left"><?php echo $cache['specialmodule']['size']; ?></td>
	</tr>
	
	<tr>
	 <td class="left"><?php echo $entry_productcategory; ?></td>
	 <td class="left"><select name="cache[productcategory][status]">
	                <?php if ($cache['productcategory']['status']) { ?>
                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                <option value="0"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_enabled; ?></option>
	...
	<td class="left"><input size="2" name="cache[productcategory][lifetime]" value="<?php echo $cache['productcategory']['lifetime']; ?>"></td>
	  <td class="left"><a href="<?php echo $clear_productcategory; ?>" class="button"><?php echo $button_clear; ?></a></td>
	 <td class="left"><?php echo $cache['productcategory']['size']; ?></td>
	</tr>	
	
	<tr>
	 <td class="left"><?php echo $entry_productmanufacturer; ?></td>
	 <td class="left"><select name="cache[productmanufacturer][status]">
	                <?php if ($cache['productmanufacturer']['status']) { ?>
                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                <option value="0"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_enabled; ?></option>
	...
	<td class="left"><input size="2" name="cache[productmanufacturer][lifetime]" value="<?php echo $cache['productmanufacturer']['lifetime']; ?>"></td>
	  <td class="left"><a href="<?php echo $clear_productmanufacturer; ?>" class="button"><?php echo $button_clear; ?></a></td>
