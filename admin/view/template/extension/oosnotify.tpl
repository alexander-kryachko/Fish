...
<?php } ?>
  ...
  <br /><center>
  <span class="help">Product Out-of-Stock Notification Version 4.2 &copy; <a href="http://www.huntbee.in/">HUNTBEE.IN</a> | WEBGURUINDIA | <a href="http://support.huntbee.in/">SUPPORT</a></span></center>
</div>
<?php echo $footer; ?>