            ...
            <tr class="multi_discount" style="display: none;">
              ...
              <td id="multi_discount_td">
				...
				<div>
					...
					<input type="text" name="discount_v[]" value="<?php echo $v; ?>" />
				...
				<div>
					...
					<input type="text" name="discount_v[]" value="0" />
				</div>
                <?php } ?>
...
$(document).ready(function() {
	...
	$('#multi_discount_td .remove-item').click(function(e) {
		$(this).parent('div').remove();
		return false;
	})
});
...
$('input[name=\'category[]\']').bind('change', function() {
	...
	//alert(filter_category_id.value);
