...
<!-------- begin ----------->
<span class="noprint">
<a href='javascript:window.print(); void 0;'>Распечатать</a>
<br><br>
</span>
<!-------- end ----------->
...
<!--	  <td><b><?php echo $column_sku; ?></b></td> -->
      <td><b><?php echo ""; ?></b></td>    <!--в этой строке---->
<!--      <td><b><?php echo "Цена"; ?></b></td>  
...
<!--      <td align="right"><?php echo $product['total']; ?></td> -->
  ...
  <br><br>
   <?php foreach ($order['voucher'] as $voucher) { ?>
	...
	<tr>
      <td align="left" colspan="2"><b><?php echo $total['title']; ?>:</b><b> <?php echo $total['text']; ?> </b></td>
 <!--     <td align="right"><?php echo $total['text']; ?></td> -->
  ...
  <table class="product" style="display:none">
    ...
    <?php foreach ($order['total'] as $total) { ?>
    <tr>
  <!--    <td align="left" colspan="4"><b><?php echo $total['title']; ?>: <?php echo $total['text']; ?></b></td> -->
      <td align="right"><?php echo $total['text']; ?></td>
    </tr>
    <?php } ?>
  </table>
