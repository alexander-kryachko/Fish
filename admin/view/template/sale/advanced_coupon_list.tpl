          ...
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'cd.name') { ?>
                ...
                <?php } ?></td>
                <td class="right"><?php if ($sort == 'cd.code') { ?>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($advanced_coupon['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $advanced_coupon['name']; ?></td>
              <td class="right"><?php echo $advanced_coupon['code']; ?></td>
              <td class="right"><?php echo $advanced_coupon['discount']; ?></td>
              <td class="left"><?php echo $advanced_coupon['date_start']; ?></td>
              <td class="left"><?php echo $advanced_coupon['date_end']; ?></td>
              <td class="left"><?php echo $advanced_coupon['status']; ?></td>
              <td class="right"><?php foreach ($advanced_coupon['action'] as $action) { ?>
