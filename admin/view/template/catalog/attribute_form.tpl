    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            <td>Показывать в сниппетах:</td>
            <td><input type="checkbox" name="enabled" <?php echo !empty($enabled) ? 'checked="checked"' : '' ?> /></td>
          </tr>
          <tr>
            <td>Показывать в &laquo;хлебных крошках&raquo;:</td>
            <td><input type="checkbox" name="breadcrumbs" <?php echo !empty($breadcrumbs) ? 'checked="checked"' : '' ?> /></td>
          </tr>
