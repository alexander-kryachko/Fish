        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="right"><?php if ($sort == 'r.rating') { ?>
                ...
                <?php } ?></td>
              <td class="right"><?php if ($sort == 'r.rating_service') { ?>
                <a href="<?php echo $sort_rating_service; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_rating_service; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_rating_service; ?>"><?php echo $column_rating_service; ?></a>
                <?php } ?></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="right"><?php echo $review['rating_service']; ?></td>
