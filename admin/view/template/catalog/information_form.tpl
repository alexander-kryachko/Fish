...
function addSeoUrl(){
var name = document.getElementById("information_description[1][title]").value;
            ...
            <table class="form">
              <tr>
                <td><span class="required">*</span> <?php echo $entry_title; ?></td>
                 ...
                 <td><input type="text" id="information_description[<?php echo $language['language_id']; ?>][title]"  onchange="addSeoUrl()" name="information_description[<?php echo $language['language_id']; ?>][title]" maxlength="255" size="100" value="<?php echo isset($information_description[$language['language_id']]) ? $information_description[$language['language_id']]['title'] : ''; ?>" />
