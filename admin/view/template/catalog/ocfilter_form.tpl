        ...
        <div id="tab-values" class="ocfilter-htab">
          ...
          <ul id="sortable">
            ...
            <li>
			  ...
			  <?/*<div class="slugHandler">slug</div>*/?>
              ...
              <div class="fields">
                ...
                <?php } ?>
				&nbsp; <label><input type="text" style="width:100px" class="value-slug" name="ocfilter_option_value[update][<?php echo $value['value_id']; ?>][slug]" value="<?php echo $value['slug']; ?>" /></label>
              </div>
