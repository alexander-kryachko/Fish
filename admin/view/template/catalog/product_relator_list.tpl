...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/product.png" alt="" /> <?php echo $text_product_relator; ?></h1>
    </div>
    <div class="content">
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'p.status') { ?>
                ...
                <?php } ?></td>
              <td class="right"><?php echo $column_related; ?>
				</td>
...
function filter() {
	url = 'index.php?route=catalog/product_relator&token=<?php echo $token; ?>';
