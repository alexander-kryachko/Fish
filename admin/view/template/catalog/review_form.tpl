    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            <td><?php echo $entry_rating_service; ?></td>
            <td><b class="rating"><?php echo $entry_bad; ?></b>&nbsp;
              <?php if ($rating_service == 1) { ?>
              <input type="radio" name="rating_service" value="1" checked />
              <?php } else { ?>
              <input type="radio" name="rating_service" value="1" />
              <?php } ?>
              &nbsp;
              <?php if ($rating_service == 2) { ?>
              <input type="radio" name="rating_service" value="2" checked />
              <?php } else { ?>
              <input type="radio" name="rating_service" value="2" />
              <?php } ?>
              &nbsp;
              <?php if ($rating_service == 3) { ?>
              <input type="radio" name="rating_service" value="3" checked />
              <?php } else { ?>
              <input type="radio" name="rating_service" value="3" />
              <?php } ?>
              &nbsp;
              <?php if ($rating_service == 4) { ?>
              <input type="radio" name="rating_service" value="4" checked />
              <?php } else { ?>
              <input type="radio" name="rating_service" value="4" />
              <?php } ?>
              &nbsp;
              <?php if ($rating_service == 5) { ?>
              <input type="radio" name="rating_service" value="5" checked />
              <?php } else { ?>
