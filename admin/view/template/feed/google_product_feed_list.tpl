        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'p.model') { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php if ($sort == 'manufacturer') { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php if ($sort == 'p.gpf_status') { ?>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td align="left"><input type="text" name="filter_manufacturer" value="<?php echo $filter_manufacturer; ?>" /></td>
              ...
              <td><select name="filter_category_id">
				  ...
				  <?php foreach($categories as $category) { ?>
					<?php if ($filter_category_id && $filter_category_id == $category['category_id']) { ?>
...
function filter() {
	url = 'index.php?route=feed/google_product_feed/bulk&token=<?php echo $token; ?>';
	...
	var filter_manufacturer = $('input[name=\'filter_manufacturer\']').attr('value');
