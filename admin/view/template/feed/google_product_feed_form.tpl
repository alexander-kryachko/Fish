...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="$('#form').submit();" class="button"><span><?php echo $button_update; ?></span></a><a onclick="location = '<?php echo $cancel; ?>';" class="button"><span><?php echo $button_cancel; ?></span></a></div>
    </div>
    <div class="content">
...
<!-- GTIN IS NOT INCLUDED BECAUSE THIS FIELD SHOULD BE UNIQUE FOR EACH PRODUCT
		  ...
		  <tr>
            ...
            <td><input type="text" name="gpf_availability_date" id="gpf_availability_date" placeholder="YYYY-MM-DD" value="<?php echo $gpf_availability_date; ?>" size="12" class="date" /><a onclick="clearField('gpf_availability_date')"><img src="view/image/clear.png" width="16" height=" 16" alt="clear" title="click here to clear this field" style="margin-left:40px; margin-right: 60px;"></a>
			<input type="text" name="gpf_availability_time" id="gpf_availability_time" placeholder="hh:mm" value="<?php echo $gpf_availability_time; ?>" size="12" class="time" /><a onclick="clearField('gpf_availability_time')"><img src="view/image/clear.png" width="16" height=" 16" alt="clear" title="click here to clear this field" style="margin-left:40px;"></a>
			</td>
          </tr>
          ...
          <tr>
            ...
            <td width="60%"><select name="gpf_is_bundle">
                <option value="X" selected="selected">Do Not Change</option>
		  ...
		  <tr>
			...
			<td><select name="identifier_exists" style="float: left; margin-right: 50px;">
				  <option value="" selected="selected"><?php echo $text_do_not_change; ?></option>
				  <option value="TRUE"><?php echo $text_true; ?></option>
				  <option value="FALSE"><?php echo $text_false; ?></option>
			</select>
			</td>
...
function addVariant() {
	...
	html += '<input type="hidden" name="product_variants[' + variants_row +'][mpn]" value="" />';
