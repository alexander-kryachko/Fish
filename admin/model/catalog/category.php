...
class ModelCatalogCategory extends Model {
    public function addCategory($data) {
        ...
        foreach ($data['category_description'] as $language_id => $value) {
            $this->db->query("INSERT INTO " . DB_PREFIX . "category_description SET category_id = '" . (int)$category_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', description = '" . $this->db->escape($value['description']) . "', seo_title = '" . $this->db->escape($value['seo_title']) . "', seo_h1 = '" . $this->db->escape($value['seo_h1']) . "', filter_title = '" . $this->db->escape($value['filter_title']) . "', filter_description = '" . $this->db->escape($value['filter_description']) . "', filter_h1 = '" . $this->db->escape($value['filter_h1']) . "'");
        }
...
// rcategory
    ...
    public function getAllCategories() {
        ...
        if (!$category_data || !is_array($category_data)) {
          ...
          //  $this->cache->set('category.all.' . $this->config->get('config_language_id') . '.' . (int)$this->config->get('config_store_id'), $category_data); //tormoza
        }
    ...
    public function getCategoryDescriptions($category_id) {
        ...
        foreach ($query->rows as $result) {
            $category_description_data[$result['language_id']] = array(
				...
				'filter_title'     => $result['filter_title'],
				'filter_description' => $result['filter_description'],
				'filter_h1'		   => $result['filter_h1']
            );
        }
