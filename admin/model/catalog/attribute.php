...
class ModelCatalogAttribute extends Model {
	...
	public function editAttribute($attribute_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "attribute SET `breadcrumbs` = ".(!empty($data['breadcrumbs']) ? '1' : '0').", `enabled` = ".(!empty($data['enabled']) ? '1' : '0').", attribute_group_id = '" . (int)$data['attribute_group_id'] . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE attribute_id = '" . (int)$attribute_id . "'");
