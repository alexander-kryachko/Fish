...
class ModelSettingHbOosn extends Model {
	...
	public function install(){
		$this->db->query("CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "out_of_stock_notify` (
		 ...
		 $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_name_enable', 'y', '0')"); 
		 $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_mobile_enable', 'n', '0')"); 
		 $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_sms_enable', 'n', '0')");
		 $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_animation', 'mfp-newspaper', '0')");
		 $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_product_qty', '1', '0')");  
		 $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_stock_status', '0', '0')"); 
		 $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_css', '#oosn_info_text, #opt_info{\r\npadding-top:0px;\r\ncolor:#F00;\r\n}\r\n\r\n#msgoosn{\r\ncolor:green;\r\n}\r\n\r\n.notify_button {\r\n  background: #fa9600;\r\n  background-image: -webkit-linear-gradient(top, #fa9600, #f55803);\r\n  background-image: -moz-linear-gradient(top, #fa9600, #f55803);\r\n  background-image: -ms-linear-gradient(top, #fa9600, #f55803);\r\n  background-image: -o-linear-gradient(top, #fa9600, #f55803);\r\n  background-image: linear-gradient(to bottom, #fa9600, #f55803);\r\n  -webkit-border-radius: 28;\r\n  -moz-border-radius: 28;\r\n  border-radius: 28px;\r\n  color: #ffffff;\r\n  font-size: 14px;\r\n  padding: 6px 20px 6px 20px;\r\n  text-decoration: none;\r\n  cursor: pointer;\r\n\r\n}\r\n\r\n.notify_button:hover {\r\n  background: #fcdc3c;\r\n  background-image: -webkit-linear-gradient(top, #fcdc3c, #fc8b00);\r\n  background-image: -moz-linear-gradient(top, #fcdc3c, #fc8b00);\r\n  background-image: -ms-linear-gradient(top, #fcdc3c, #fc8b00);\r\n  background-image: -o-linear-gradient(top, #fcdc3c, #fc8b00);\r\n  background-image: linear-gradient(to bottom, #fcdc3c, #fc8b00);\r\n  text-decoration: none;\r\n}', '0')");
		 $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_mobile_validation', '10', '0')");

		 $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_csource', 'Huntbee', '0')");
		 $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_cmedium', 'stock_email', '0')");
		 $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_cname', 'Back In-Stock', '0')");

		$this->load->model('localisation/language');
		$languages = $this->model_localisation_language->getLanguages();
		
		foreach ($languages as $language){
			$this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_admin_email_subject_".md5($language['code'])."', 'Customer is looking for a product', '0'); ");
			$this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_admin_email_body_".md5($language['code'])."', 'Dear Store Admin,\r\n\r\nOne of your customers is looking for a product. The details of the product are as follows\r\n\r\nProduct ID : {product_id}\r\nProduct Name : {product_name}\r\nProduct SKU : {sku}\r\nCustomer Selected Options: {all_option}\r\nOptions Out of Stock : {option}\r\n\r\nCUSTOMER DETAILS:\r\nCustomer Name : {fname}\r\nCustomer Email : {customer_email}\r\nCustomer Phone : {phone} ', '0'); ");
		$this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_customer_email_subject_".$language['language_id']."', 'Your Requested Product is now Available to purchase', '0'); ");
		$this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_customer_email_body_".$language['language_id']."', '&lt;table align=&quot;center&quot; bgcolor=&quot;#f9f9f9&quot; cellpadding=&quot;10px&quot; width=&quot;90%&quot;&gt;\r\n	&lt;tbody&gt;\r\n		&lt;tr&gt;\r\n			&lt;td&gt;\r\n			&lt;p&gt;Hi {customer_name},&lt;/p&gt;\r\n\r\n			&lt;p&gt;The product {product_name} {option} Model: {model}, you requested for is now available for ordering.&lt;/p&gt;\r\n\r\n			&lt;table cellpadding=&quot;10&quot;&gt;\r\n				&lt;tbody&gt;\r\n					&lt;tr&gt;\r\n						&lt;td&gt;{show_image}&lt;/td&gt;\r\n						&lt;td&gt;&lt;b&gt;{product_name}&lt;/b&gt;&lt;br /&gt;\r\n						Model: {model}&lt;br /&gt;\r\n						&lt;br /&gt;\r\n						&lt;a class=&quot;button&quot; href=&quot;{link}&quot;&gt;BUY NOW ! Limited Stock !&lt;/a&gt;&lt;/td&gt;\r\n					&lt;/tr&gt;\r\n				&lt;/tbody&gt;\r\n			&lt;/table&gt;\r\n\r\n			&lt;p&gt;Regards,&lt;/p&gt;\r\n\r\n			&lt;p&gt;Your Store Name&lt;/p&gt;\r\n			&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n	&lt;/tbody&gt;\r\n&lt;/table&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n', '0'); ");
		$this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_product_image_h_".$language['language_id']."', '80', '0'); ");
		$this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_product_image_w_".$language['language_id']."', '80', '0'); ");
		$this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn', 'hb_oosn_customer_sms_body_".$language['language_id']."', '{product_name} {model} {option} is back in stock. Visit huntbee.com to buy it now.', '0'); ");
		}

	    $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES (NULL, '0', 'hb_oosn_installer', 'hb_oosn_installed', '1', '0')"); 
	}
	
	public function uninstall() {
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "out_of_stock_notify`");
		$this->db->query("DELETE FROM `" . DB_PREFIX . "setting` WHERE `group` = 'hb_oosn'");
		$this->db->query("DELETE FROM `" . DB_PREFIX . "setting` WHERE `group` = 'hb_oosn_installer'");
