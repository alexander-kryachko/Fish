	...
	public function index() { 
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
            ...
            if ($this->config->get('sphinx_search_module')) {
                ...
                $sphinxResult = $this->model_catalog_sphinx->search($data, null, $wildcard);
                ...
                if ($product_total == 0) {
                    $this->data['search_suggestion'] = $this->model_catalog_sphinx->buildSuggestion($data['filter_name']);
                }
