<?php echo $header; ?>
  <div id="content">
    ...
    <div class="box">
      <div class="heading">
        <h1><img src="view/image/order.png" alt="" /> <?php echo $heading_title; ?></h1>
    					...
    					<div class="buttons"><?php if ($shipping_code == 'novaposhta.novaposhta') { ?><a href="<?php echo $novaposhta_ei; ?>" class="button" style="background: red" target="_blank"><?php echo $button_create_ei; ?></a><?php } ?>
    				
        		<a href="index.php?route=sale/novaposhta_ei/getForm&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>" target="_blank" class="button">Создать ЭН</a> <a href="<?php echo $invoice; ?>" target="_blank" class="button"><?php echo $button_invoice; ?></a><a href="<?php echo $cancel; ?>" class="button"><?php echo $button_cancel; ?></a></div>
      </div>
      ...
      <div class="content">
        ...
        <div style="width:49%;float:left">
          <table class="form tiny">
            <tr><td><?php echo $text_order_id; ?></td><td>#<?php echo $order_id; ?></td></tr>
            <?php if ($customer) { ?><tr><td><?php echo $text_customer; ?></td><td><a href="<?php echo $customer; ?>"><?php echo $firstname; ?> <?php echo $lastname; ?></a></td></tr>
            <?php } else { ?><tr><td><?php echo $text_customer; ?></td><td><?php echo $firstname; ?> <?php echo $lastname; ?></td></tr><?php } ?>
            <?php if ($customer_group) { ?><tr><td><?php echo $text_customer_group; ?></td><td><?php echo $customer_group; ?></td></tr><?php } ?>
            <? if (!empty($telephone)){ ?><tr><td><?php echo $text_telephone; ?></td><td><?php echo $telephone; ?></td></tr><? } ?>
            <?php if ($fax) { ?><tr><td><?php echo $text_fax; ?></td><td><?php echo $fax; ?></td></tr><?php } ?>
            <?php /* if ($shipping_method) { ?><tr><td><?php echo $text_shipping_method; ?></td><td><?php echo $shipping_method; ?></td></tr><?php } */?>
            <? if (!empty($payment_city)){ ?><tr><td><?php echo $text_city; ?></td><td><?php echo $payment_city.', '.$payment_zone_id; ?><?php /*echo ', '. $payment_country;*/ ?></td></tr><? } ?>
            <? if (!empty($payment_address_1) && empty($shipping_address_1)){ ?>
              <tr><td><?php echo $text_address_1; ?></td><td><?php echo $payment_postcode.', '.$payment_address_1; ?></td></tr>
            <? }else{ ?>
              <tr><td><?php echo $text_address_1; ?></td><td><?php echo $payment_postcode.', '.$shipping_address_1; ?></td></tr>
            <?php }?>
            <? if (!empty($email)){ ?><tr><td><?php echo $text_email; ?></td><td><?php echo $email; ?></td></tr><? } ?>
            <tr><td><?php echo $text_payment_method; ?></td>
              <td>
                <? if ($payment_code == 'cod') {
                  echo 'Наличный расчет оплата при получении';
                } elseif($payment_code == 'bank_transfer') {
                  echo 'Перевод на карту Приватбанка';
                } elseif($payment_code == 'cheque') {
                  echo 'Безналичный платеж';
                } else {
                  echo $payment_method;
                }
                ?>
            ...
            <tr>
              <td>
                <?php echo "Адрес доставки для пункта Курьером в Киеве:"; ?>
              </td>
              <td>
            ...
            <?/*
          <tr><td><?php echo $text_total; ?></td>
            <td><?php echo $total; ?>
              <?php if ($credit && $customer) { ?>
				<?php if (!$credit_total) { ?><span id="credit"><b>[</b> <a id="credit-add"><?php echo $text_credit_add; ?></a> <b>]</b></span>
				<?php } else { ?><span id="credit"><b>[</b> <a id="credit-remove"><?php echo $text_credit_remove; ?></a> <b>]</b></span><?php } ?>
              <?php } ?></td>
          </tr>

          <?php if ($ip) { ?><tr><td><?php echo $text_ip; ?></td><td><?php echo $ip; ?></td></tr><?php } ?>
          <?php if ($forwarded_ip) { ?><tr><td><?php echo $text_forwarded_ip; ?></td><td><?php echo $forwarded_ip; ?></td></tr><?php } ?>
          <?php if ($user_agent) { ?><tr><td><?php echo $text_user_agent; ?></td><td><?php echo $user_agent; ?></td></tr><?php } ?>
          <?php if ($accept_language) { ?><tr><td><?php echo $text_accept_language; ?></td><td><?php echo $accept_language; ?></td></tr><?php } ?>
          <tr><td><?php echo $text_date_modified; ?></td><td><?php echo $date_modified; </td></tr>

          <tr><td><?php echo $text_firstname; ?></td><td><?php echo $payment_firstname; ?></td></tr>
          <tr><td><?php echo $text_lastname; ?></td><td><?php echo $payment_lastname; ?></td></tr>
          <?php if ($payment_company) { ?><tr><td><?php echo $text_company; ?></td><td><?php echo $payment_company; ?></td></tr><?php } ?>
          <?php if ($payment_company_id) { ?><tr><td><?php echo $text_company_id; ?></td><td><?php echo $payment_company_id; ?></td></tr><?php } ?>          
          <?php if ($payment_tax_id) { ?><tr><td><?php echo $text_tax_id; ?></td><td><?php echo $payment_tax_id; ?></td></tr><?php } ?>            
          <tr><td><?php echo $text_address_1; ?></td><td><?php echo $payment_address_1; ?></td></tr>
          <?php if ($payment_address_2) { ?><tr><td><?php echo $text_address_2; ?></td><td><?php echo $payment_address_2; ?></td></tr><?php } ?>
		  <tr><td><?php echo $text_city; ?></td><td><?php echo $payment_city; ?></td></tr>
          <?php if ($payment_postcode) { ?><tr><td><?php echo $text_postcode; ?></td><td><?php echo $payment_postcode; ?></td></tr><?php } ?>
          <tr><td><?php echo $text_zone; ?></td><td><?php echo $payment_zone; ?></td></tr>
          <?php if ($payment_zone_code) { ?><tr><td><?php echo $text_zone_code; ?></td><td><?php echo $payment_zone_code; ?></td></tr><?php } ?>
          <tr><td><?php echo $text_country; ?></td><td><?php echo $payment_country; ?></td></tr>
          <tr><td><?php echo $text_payment_method; ?></td><td><?php echo $payment_method; ?></td></tr>
		  
          <tr><td><?php echo $text_firstname; ?></td><td><?php echo $shipping_firstname; ?></td></tr>
          <tr><td><?php echo $text_lastname; ?></td><td><?php echo $shipping_lastname; ?></td></tr>
          <?php if ($shipping_company) { ?><tr><td><?php echo $text_company; ?></td><td><?php echo $shipping_company; ?></td></tr><?php } ?>
          <tr><td><?php echo $text_address_1; ?></td><td><?php echo $shipping_address_1; ?></td></tr>
          <?php if ($shipping_address_2) { ?><tr><td><?php echo $text_address_2; ?></td><td><?php echo $shipping_address_2; ?></td></tr><?php } ?>
          <tr><td><?php echo $text_city; ?></td><td><?php echo $shipping_city; ?></td></tr>
          <?php if ($shipping_postcode) { ?><tr><td><?php echo $text_postcode; ?></td><td><?php echo $shipping_postcode; ?></td></tr><?php } ?>
          <tr><td><?php echo $text_zone; ?></td><td><?php echo $shipping_zone; ?></td></tr>
          <?php if ($shipping_zone_code) { ?><tr><td><?php echo $text_zone_code; ?></td><td><?php echo $shipping_zone_code; ?></td></tr><?php } ?>
          <tr><td><?php echo $text_country; ?></td><td><?php echo $shipping_country; ?></td></tr>
          <?php if ($shipping_method) { ?><tr><td><?php echo $text_shipping_method; ?></td><td><?php echo $shipping_method; ?></td></tr><?php } ?>		  
		  */?>


            <?php if ($reward && $customer) { ?><tr><td><?php echo $text_reward; ?></td><td><?php echo $reward; ?>
                <?php if (!$reward_total) { ?><span id="reward"><b>[</b> <a id="reward-add"><?php echo $text_reward_add; ?></a> <b>]</b></span>
                <?php } else { ?><span id="reward"><b>[</b> <a id="reward-remove"><?php echo $text_reward_remove; ?></a> <b>]</b></span><?php } ?></td>
              </tr><?php } ?>

            <?php if ($comment) { ?><tr><td><?php echo $text_comment; ?></td><td><?php echo $comment; ?></td></tr><?php } ?>
            <?php if ($affiliate) { ?>
              <tr><td><?php echo $text_affiliate; ?></td><td><a href="<?php echo $affiliate; ?>"><?php echo $affiliate_firstname; ?> <?php echo $affiliate_lastname; ?></a></td></tr>
              <tr><td><?php echo $text_commission; ?></td><td><?php echo $commission; ?>
                  <?php if (!$commission_total) { ?><span id="commission"><b>[</b> <a id="commission-add"><?php echo $text_commission_add; ?></a> <b>]</b></span>
                  <?php } else { ?><span id="commission"><b>[</b> <a id="commission-remove"><?php echo $text_commission_remove; ?></a> <b>]</b></span><?php } ?></td></tr>
            <?php } ?>
          </table>
          <div>
        ...
        <div style="width:48%;float:right">
          <table class="form tiny">
            ...
            <?php if ($order_status) { ?><tr><td><?php echo $text_order_status; ?></td><td id="order-status"><?php echo $order_status; ?></td></tr><?php } ?>
            <?/*
          <tr><td><?php echo $text_total; ?></td>
            <td><?php echo $total; ?>
              <?php if ($credit && $customer) { ?>
		  ...
		  */?>
            ...
            <p><strong><span style="color:#ff0000;">Специальное предложение! До отправки.</span></strong></p>
            <p><strong>Удилища:</strong></p>
            <ul>
              <li>15% на еще 1 удилище</li>
              <li>15% на катушки</li>
              <li>15% на шнуры</li>
            </ul>
            <p><strong>Катушки:</strong></p>
            <ul>
              <li>15% на еще 1 катушку</li>
              <li>15% на шнуры</li>
            </ul>
            <p><strong>Воблеры, силикон (пачки)</strong></p>
            <ul>
              <li>10% на воблеры</li>
              <li>10% на силикон</li>
              <li>10% на шнуры</li>
        ...
        <div id="tab-product" class="vtabs-content--" style="width:49%;float:left;">
          <table class="list">
            <thead>
            <tr>
              <td class="left"></td>
              ...
              <tr>
                <td class="center"><?
                  if (!empty($product['picture'])){
                    echo '<img src="/image/'.$product['picture'].'" alt="" width="100px" />';
                  }
                  ?></td>
        ...
        <div id="tab-history" class="vtabs-content--" style="width:48%;float:right;">
          <div id="history"></div>
          <table class="form">
            <tr>
              <td><?php echo $entry_order_status; ?></td>
              <td><select name="order_status_id" id="order_status_id_select">
            ...
            <tr>
              ...
              <td><textarea name="comment" cols="40" rows="8" style="width: 99%"></textarea>
                <?
                $canBanStatus = 7;
                if (!empty($canBanStatus)){ ?>
                  <div id="addToBanCont" style="padding:6px 0"><label><input type="checkbox" value="addtoban" value="1" style="vertical-align:middle;"/> Отправить контакты в черный список</label></div>
                  <?/* <script type="text/javascript">
				$(document).ready(function(){
					var order_status_change = function(event){
						var v = $('#order_status_id_select').find('option:selected').val();
						if (v == <?=$canBanStatus?>) $('#addToBanCont').show();
							else {
								$('#addToBanCont').hide();
								$('#addToBanCont input').attr('checked', false);
							}
					}
					$('#order_status_id_select').bind('change', order_status_change);
					order_status_change();
				});
			  </script> */?>
                <? } ?>
    ...
    <div style="text-align:center"><iframe name="Отслеживание посылок Otsledit.com" src="http://checkpn.com/delivery/novaposhta/check.html" scrolling="auto" width="1000" height="600" frameborder="0"></iframe></div>
  </div>
  ...
  <script type="text/javascript"><!--
    ...
    $('#button-history').live('click', function() {
      $.ajax({
        ...
        type: 'post',
        dataType: 'html',
        data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&addtoban='+encodeURIComponent($('#addToBanCont input').attr('checked') == 'checked' ? 1 : 0)+'&notify=' + encodeURIComponent($('input[name=\'notify\']').attr('checked') ? 1 : 0) + '&append=' + encodeURIComponent($('input[name=\'append\']').attr('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()),
        beforeSend: function() {
          $('.success, .warning').remove();
