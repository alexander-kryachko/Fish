...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="content"><?php echo $text_empty; ?>
				...
				?>
		  			<div class="sphinx-suggestion"><?php echo $entry_suggestion; ?> <a href="<?php echo $this->url->link('product/search', $query_string.'='.$search_suggestion); ?>"><?php echo $search_suggestion; ?></a>?</div>
		  		<?php } ?></div>
  <?php }?>
