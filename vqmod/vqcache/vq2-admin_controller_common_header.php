...
class ControllerCommonHeader extends Controller {
    protected function index() {
		...
		$this->data['text_customer_ban_email'] = $this->language->get('text_customer_ban_email');
		$this->data['text_customer_ban_phone'] = $this->language->get('text_customer_ban_phone');
		...
		$this->data['text_hb_oosn'] = $this->language->get('text_hb_oosn');
...
$this->data['text_article'] = $this->language->get('text_article');
                          ...
                          $this->data['text_image_search'] = $this->language->get('text_image_search');
        ...
        $this->data['text_ocfilter_meta'] = $this->language->get('text_ocfilter_meta');

    $this->data['text_suppler'] = $this->language->get('text_suppler');
...
$this->data['text_report_adv_product_purchased'] = $this->language->get('text_report_adv_product_purchased');
	...
	$this->data['mass_p_u_code']=$begin_code.$middle_code.$end_code;
            ...
            $this->data['export'] = $this->url->link('tool/smartexportimport', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->data['advanced_coupon'] = $this->url->link('sale/advanced_coupon', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['customer_ban_email'] = $this->url->link('sale/customer_ban_email', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['customer_ban_phone'] = $this->url->link('sale/customer_ban_phone', 'token=' . $this->session->data['token'], 'SSL');
...
$this->data['exchange1c'] = $this->url->link('module/exchange1c', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['hb_oosn_link'] = $this->url->link('extension/hb_oosn', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['filter'] = $this->url->link('catalog/filter', 'token=' . $this->session->data['token'], 'SSL');
        $this->data['text_generate_sitemap'] = $this->language->get('text_generate_sitemap');
        $this->data['generate_sitemap'] = $this->url->link('tool/generate_sitemap', 'token=' . $this->session->data['token'], 'SSL');
...
$this->data['article'] = $this->url->link('catalog/article', 'token=' . $this->session->data['token'], 'SSL');
                          ...
                          $this->data['image_search'] = $this->url->link('catalog/image_search', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['ocfilter_meta'] = $this->url->link('catalog/ocfilter_meta', 'token=' . $this->session->data['token'], 'SSL');
    $this->data['suppler'] = $this->url->link('catalog/suppler', 'token=' . $this->session->data['token'], 'SSL');
