...
<?php if (in_array($menu['id'], $in_module)) { ?>
	<?php if($menu['sub_menu']){ ?>
		<li class="arrow"><a href="<?php echo $menu['link'] ?>"><?php if($menu['image']) { ?><img src="<?php echo $menu['image']; ?>" alt="<?php echo $menu['name']; ?>" /><?php } ?> <?php echo $menu['name']; ?></a>
	<?php } else {?>
		<li><a href="<?php echo $menu['link'] ?>"><?php if($menu['image']) { ?><img src="<?php echo $menu['image']; ?>" alt="<?php echo $menu['name']; ?>" /><?php } ?> <?php echo $menu['name']; ?></a>
	<?php }?>		
	<?php if($menu['sub_menu']){ ?>
		<div>
