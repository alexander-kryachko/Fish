...
<?php if ($products) { ?>
    <div class="heading-products"><?php echo $heading_products; ?></div>                                
                            <div id="set-<?php echo $set_id; ?>">
                                <div class="wrap-set">
                                        ...
                                        <div class="wrap-product-item">
                                            ...
                                            <div class="product-item <?php if(!$product['active']){?>notactive<?php } ?>" id="product-<?php echo $i; ?>">
                                                ...
                                                <?php if ($product['options']) { ?>
                                                      <div id="options-<?php echo $set_id; ?>" class="options">
                                                        <?php foreach ($product['options'] as $option) { ?>
                                                            <?php if ($option['type'] == 'select') { ?>
                                                                <div id="option-<?php echo $option['product_option_id']; ?>-<?php echo $set_id; ?>-<?php echo $i; ?>" class="option">
                                                              ...
                                                              <?php foreach ($option['option_value'] as $option_value) { ?>
                                                                  <?php if($option['selected']){?>
                                                                    <?php if($option_value['selected']){?>
                                                                        <input type="radio" name="option[<?php echo $product['product_id']; ?>][<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>-<?php echo $product['product_id']; ?>-<?php echo $set_id; ?>" checked="checked" disabled="disabled" />
                                                                         <label for="option-value-<?php echo $option_value['product_option_value_id']; ?>-<?php echo $product['product_id']; ?>-<?php echo $set_id; ?>">
                                                                            <?php echo $option_value['name']; ?>
                                                                        </label>
                                                                    <?php }else{ continue; }?>
                                                                  <?php } else { ?>
                                                                    <input type="radio" name="option[<?php echo $product['product_id']; ?>][<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>-<?php echo $product['product_id']; ?>-<?php echo $set_id; ?>" <?php if(!$option_value['active']){?>disabled="disabled"<?php } ?>  />
                                                                    <label for="option-value-<?php echo $option_value['product_option_value_id']; ?>-<?php echo $product['product_id']; ?>-<?php echo $set_id; ?>">
                                                                        <?php echo $option_value['name']; ?>
                                                                    </label>
                                                                  <?php } ?>
                                                            ...
                                                            <div id="option-<?php echo $option['product_option_id']; ?>-<?php echo $set_id; ?>-<?php echo $i; ?>" class="option">
                                                              ...
                                                              <b><?php echo $option['name']; ?>:</b><br />
                                                              <?php foreach ($option['option_value'] as $option_value) { ?>
                                                                  <input type="checkbox" name="option[<?php echo $product['product_id']; ?>][<?php echo $option['product_option_id']; ?>][]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>-<?php echo $product['product_id']; ?>-<?php echo $set_id; ?>" <?php if($option_value['selected']){?>checked="checked" disabled="disabled"<?php } ?> <?php if(!$option_value['active']){?>disabled="disabled"<?php } ?> />
                                                                  <label for="option-value-<?php echo $option_value['product_option_value_id']; ?>-<?php echo $product['product_id']; ?>-<?php echo $set_id; ?>">
                                                                    <?php echo $option_value['name']; ?>
                                                                  </label>
                                                                  <br />
                                                            ...
                                                            <div id="option-<?php echo $option['product_option_id']; ?>-<?php echo $set_id; ?>-<?php echo $i; ?>" class="option">
                                                              ...
                                                              <table class="option-image">
                                                                <?php foreach ($option['option_value'] as $option_value) { ?>
                                                                  <?php if($option['selected']){?>
                                                                    <?php if($option_value['selected']){?>
                                                                        <tr>
                                                                          ...
                                                                          <td><label for="option-value-<?php echo $option_value['product_option_value_id']; ?>-<?php echo $product['product_id']; ?>-<?php echo $set_id; ?>"><img src="<?php echo $option_value['image']; ?>" alt="<?php echo $option_value['name']; ?>" /></label></td>
                                                                          <td>
                                                                            <label for="option-value-<?php echo $option_value['product_option_value_id']; ?>-<?php echo $product['product_id']; ?>-<?php echo $set_id; ?>">
                                                                                <?php echo $option_value['name']; ?>
                                                                            </label>
                                                                  ...
                                                                  <?php } else { ?>
                                                                    <tr>
                                                                      <td style="width: 1px;"><input type="radio" name="option[<?php echo $product['product_id']; ?>][<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>-<?php echo $product['product_id']; ?>-<?php echo $set_id; ?>" <?php if(!$option_value['active']){?>disabled="disabled"<?php } ?> /></td>
                                                                      <td><label for="option-value-<?php echo $option_value['product_option_value_id']; ?>-<?php echo $product['product_id']; ?>-<?php echo $set_id; ?>"><img src="<?php echo $option_value['image']; ?>" alt="<?php echo $option_value['name']; ?>" /></label></td>
                                                                      <td>
                                                                        <label for="option-value-<?php echo $option_value['product_option_value_id']; ?>-<?php echo $product['product_id']; ?>-<?php echo $set_id; ?>">
                                                                            <?php echo $option_value['name']; ?>
                                                            ...
                                                            <div id="option-<?php echo $option['product_option_id']; ?>-<?php echo $set_id; ?>" class="option">
                                                              <?php if ($option['required']) { ?>
                                                              <span class="required">*</span>
                                                              <?php } ?>
                                                              <b><?php echo $option['name']; ?>:</b><br />
                                                            ...
                                                            <?php if ($option['type'] == 'file') { ?>
                                                                <div id="option-<?php echo $option['product_option_id']; ?>-<?php echo $set_id; ?>-<?php echo $i; ?>" class="option">
                                                                  ...
                                                                  <b><?php echo $option['name']; ?>:</b><br />
                                                                   ...
                                                                   <input type="button" value="<?php echo $button_upload; ?>" id="button-option-file-upload-set-<?php echo $set_id; ?>-<?php echo $i; ?>" class="button" />
                                                                   <input type="hidden" name="option[<?php echo $product['product_id']; ?>][<?php echo $option['product_option_id']; ?>]" value="" />

                                                                </div>
                                                                <br />
                                                                <script type="text/javascript">
                                                                    new AjaxUpload('#button-option-file-upload-set-<?php echo $set_id; ?>-<?php echo $i; ?>', {
                                                                    	action: 'index.php?route=product/product/upload',
                                                                    	name: 'file',
                                                                    	autoSubmit: true,
                                                                    	responseType: 'json',
                                                                    	onSubmit: function(file, extension) {
                                                                    		$('#button-option-file-upload-set-<?php echo $set_id; ?>-<?php echo $i; ?>').after('<img src="catalog/view/theme/default/image/loading.gif" class="loading" style="padding-left: 5px;" />');
                                                                    		$('#button-option-file-upload-set-<?php echo $set_id; ?>-<?php echo $i; ?>').attr('disabled', true);
                                                                    	},
                                                                    	onComplete: function(file, json) {
                                                                    		$('#button-option-file-upload-set-<?php echo $set_id; ?>-<?php echo $i; ?>').attr('disabled', false);
                                                                    		$('.error').remove();
                                                                    		if (json['success']) {
                                                                    			$('#set-<?php echo $set_id; ?> #product-<?php echo $i; ?> input[name=\'option[<?php echo $product['product_id']; ?>][<?php echo $option['product_option_id']; ?>]\']').attr('value', json['file']);
                                                                    		}
                                                                    		if (json['error']) {
                                                                    			$('#option-<?php echo $option['product_option_id']; ?>-<?php echo $set_id; ?>-<?php echo $i; ?>').after('<span class="error">' + json['error'] + '</span>');
                                                                    		}
                                                                    		$('.loading').remove();	
                                                                    	}
                                                                    });
                                    ...
                                    <div class="set-item">
                                        <div class="set-description">
                                            <div class="set-description-content">
                                                <div class="economy">
                                                    <span class="caption"><?php echo $text_save; ?></span> <span class="value"><?php echo $set_save; ?></span>
                                                </div>
                                                <div class="set-total">
                                                    <span class="caption"><?php echo $text_total; ?></span> <span class="value"><?php echo $set_price; ?></span>
                                                </div>
                                            </div>
                                            <div class="button-block">
                                                <input type="hidden" name="set_id" value="<?php echo $set_id; ?>" />
                                                <?php if($active_set){?>
                                                    <a class="button" onclick="AddToCartSet('<?php echo $set_id; ?>');" ><?php echo $button_cart; ?></a>
                                                <?php } else { ?>
