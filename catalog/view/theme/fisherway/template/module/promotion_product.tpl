  <div class="product-promotion">
    ...
    <div class="promotion-details">
      <div class="details-title">
        <a class="pcolorbox_ajax"  href="index.php?route=product/product/getPromotion&promotion_id=<?=$promotion_id?>"><?php echo $promotion_about; ?>&nbsp;▼</a>
      </div>
  ...
  <script type="text/javascript">$(document).ready(function(){$(".pcolorbox_ajax").colorbox({width:"500px", opacity: 0.5}); });</script>