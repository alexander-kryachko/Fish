...
<div class="pagination"><?php echo $pagination; ?></div>
		...
		<?php
		if (!empty($reviews_cat)  && (!isset($_GET['page']) || $_GET['page'] == 1)){
			// $_SERVER['REMOTE_ADDR'] == '37.57.71.114'
			echo '<div class="aggregatedComments category-comments"><div class="aggregatedCommentsInner">';
			echo '<h2>'.$seo_h1.'&nbsp;&mdash; лучшие отзывы покупателей</h2>';

			foreach($reviews_cat as $r){
				echo '<div class="comment">';
				echo '<a class="title" href="'.$r['href'].'">'.$r['product'].'</a>';
