...
<table>
	...
	<div class="product-descri">
        <h2 id="opisanie">Описание TOPTEXT</h2>
		<?php echo $statuses; ?>
...
<tr>
  ...
  <a href="<?php echo $manufacturers; ?>"><?php echo $manufacturer; ?> Украина</a>
    <?php
...
//<!-- ВЫЗОВ СОБЫТИЙ -->
rnt('add_audience', {audienceId: '14875_3d3cf2c2-8487-4abf-a02f-bb7705a27fc7', priceId: '446', productId: '<?php echo $product_id; ?>'});
rnt('add_product_event', {advId: '14875', priceId: '446', productId: '<?php echo $product_id; ?>'});
//<!-- КОНЕЦ ВЫЗОВА СОБЫТИЙ -->
...
<script type="application/ld+json">
{
  ...
  "image": "<?php echo 'http://fisherway.com.ua/image/'.$image['popup'].''; ?>",
