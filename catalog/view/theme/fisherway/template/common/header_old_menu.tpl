...
<link rel="stylesheet" media="screen and (max-width: 350px)" href="/catalog/view/theme/fisherway/stylesheet/_stylesheet_mobile.css?v=1.5" />
...
*/
?><link rel="stylesheet" type="text/css" href="/catalog/view/theme/fisherway/stylesheet/_stylesheet.css?v=1.30" /><?php
