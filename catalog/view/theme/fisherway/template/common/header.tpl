...
<head>
    ...
    */
    ?><link rel="stylesheet" type="text/css" href="/catalog/view/theme/fisherway/stylesheet/stylesheet.css?v=2.1" /><?php
    ...
    */
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            var timer = null;
            $('#search input, #search-404 input').keydown(function(){

                var search_id = $(this).attr('id');
                clearTimeout(timer);
                timer = setTimeout(sphinxAutocomplete2(search_id), 500)
            });
        ...
        $(document).mouseup(function (e) {
            ...
            if (!$('.sphinxsearch').is(e.target) && $('.sphinxsearch').has(e.target).length === 0) {
                $('.sphinxsearch').hide();
                $('#search input, #search-404 input').removeClass('no-bottom-borders');
                return false;
            }
        ...
        function sphinxAutocomplete2(search_id) {
            ...
            $.ajax({
                url: 'http://test666.fisherway.com.ua/index.php?route=module/sphinxautocomplete&search=' + $('#'+search_id).val(),
                dataType: 'json',
                success: function(json) {
                    ...
                    $('#'+search_id).after('<div class="sphinxsearch">'+ html +'</div>');
                    $('.sphinxsearch').show();
...
<body>
<!--<div class="width2">
    <a class="black-friday" href="http://fisherway.com.ua/chernaya-pyatnica" target="_blank"><img src="/image/black-friday.jpg" alt="Черная пятница" class="img-responsive"></a>
</div>-->
<div class="page-container" style="position: relative; top: 0;">
    <div class="page-container-in">
        ...
        if (strpos($url,'chernaya-pyatnica') !== false) {
        ?><div class="page-itself bf-container"><?
            } else {
            ?>
