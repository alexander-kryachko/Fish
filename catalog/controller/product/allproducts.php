...
class ControllerProductAllproducts extends Controller {  
	public function index() { 
		...
		if (isset($this->request->get['limit'])) {
			$test = $this->request->get['limit'];
			  if ($test == '15' || $test == '25' || $test == '50'|| $test == '75' || $test == '100') {
		...
		if (file_exists(DIR_APPLICATION . '/view/javascript/jquery/jquery.total-storage.min.js')) {
		...
		$this->data['compare'] = $this->url->link('product/compare');
			...
			$this->data['limits'][] = array(
				...
				'href'  => $this->url->link('product/allproducts', $url . '&limit=' . $this->config->get('config_catalog_limit'))
			);
						
			$this->data['limits'][] = array(
				'text'  => 25,
				'value' => 25,
				'href'  => $this->url->link('product/allproducts', $url . '&limit=25')
			);
			
			$this->data['limits'][] = array(
				'text'  => 50,
				'value' => 50,
				'href'  => $this->url->link('product/allproducts', $url . '&limit=50')
			);

			$this->data['limits'][] = array(
				'text'  => 75,
				'value' => 75,
				'href'  => $this->url->link('product/allproducts', $url . '&limit=75')
			);
			
			$this->data['limits'][] = array(
				'text'  => 100,
				'value' => 100,
				'href'  => $this->url->link('product/allproducts', $url . '&limit=100')
			);
