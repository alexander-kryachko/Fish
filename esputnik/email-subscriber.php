...
$days = 3;					// Время действия купона в днях. 0 - без ограничения.
...
$coupon_name = 'Подписчик неделю не покупал'; // Название купона (необязательно, по умолчанию = "Дисконтная карта (Esputnik) №...")
$coupon_prefix = 'sb-';		// Префикс купона (необязательно)
