...
$days = 7;					// Время действия купона в днях. 0 - без ограничения.
...
$coupon_name = 'Активация второй покупки'; // Название купона (необязательно, по умолчанию = "Дисконтная карта (Esputnik) №...")
$coupon_prefix = '22-';		// Префикс купона (необязательно)
